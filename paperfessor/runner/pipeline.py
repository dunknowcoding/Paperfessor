...
def _related_prompt(direction: str, method: str, evidence: list[Evidence]) -> str:
    return (
        ...
        f"Anchor the discussion on work from LEADING venues in the field "
        f"(the strongest papers cite predominantly top-tier conferences "
        f"and journals); prefer seminal, highly-cited references. "
